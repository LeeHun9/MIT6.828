 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 577:	90                   	nop
          s = "(null)";
 578:	ba 28 07 00 00       	mov    $0x728,%edx
        while(*s != 0){
 ...
 591:	a1 30 0a 00 00       	mov    0xa30,%eax
{
 ...
 612:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
 615:	8b 43 f8             	mov    -0x8(%ebx),%eax
 618:	89 02                	mov    %eax,(%edx)
}
 61a:	5b                   	pop    %ebx
 61b:	5e                   	pop    %esi
 61c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a2:	e8 e9 fe ff ff       	call   590 <free>
  return freep;
 6a7:	a1 30 0a 00 00       	mov    0xa30,%eax
 ...
 6d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 6d7:	a3 30 0a 00 00       	mov    %eax,0xa30
}
