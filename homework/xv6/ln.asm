 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 88 07 00 00 	jmp    *0x788(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 7f 07 00 00       	mov    $0x77f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 8c 0a 00 00       	mov    0xa8c,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a7:	73 4f                	jae    6f8 <malloc+0xa8>
    ...
    if(p == freep)
 6a9:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 8c 0a 00 00       	mov    0xa8c,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
