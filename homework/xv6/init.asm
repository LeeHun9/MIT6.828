 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 40 08 00 00 	jmp    *0x840(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 38 08 00 00       	mov    $0x838,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 4c 0b 00 00       	mov    0xb4c,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
