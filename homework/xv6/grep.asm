...
main(int argc, char *argv[])
{
  ...
  81:	e8 9a 06 00 00       	call   720 <printf>
      exit();
  86:	e8 28 05 00 00       	call   5b3 <exit>
  }
  exit();
  8b:	e8 23 05 00 00       	call   5b3 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 82 06 00 00       	call   720 <printf>
    exit();
  9e:	e8 10 05 00 00       	call   5b3 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 01 05 00 00       	call   5b3 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 be 03 00 00       	call   5cb <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 42 03 00 00       	call   5d3 <write>
 ...
 2e1:	89 4d dc             	mov    %ecx,-0x24(%ebp)
      memmove(buf, p, m);
 2e4:	e8 97 02 00 00       	call   580 <memmove>
...
strcmp(const char *p, const char *q)
{
 ...
 3b4:	eb 2e                	jmp    3e4 <strcmp+0x44>
 3b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 3bd:	8d 76 00             	lea    0x0(%esi),%esi
 3c0:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    p++, q++;
 3c4:	83 c1 01             	add    $0x1,%ecx
 3c7:	8d 5a 01             	lea    0x1(%edx),%ebx
  while(*p && *p == *q)
 3ca:	84 c0                	test   %al,%al
 3cc:	74 12                	je     3e0 <strcmp+0x40>
    p++, q++;
 3ce:	89 da                	mov    %ebx,%edx
  while(*p && *p == *q)
 3d0:	0f b6 1a             	movzbl (%edx),%ebx
 3d3:	38 c3                	cmp    %al,%bl
 ...
 3de:	66 90                	xchg   %ax,%ax
  return (uchar)*p - (uchar)*q;
 3e0:	0f b6 5a 01          	movzbl 0x1(%edx),%ebx
...
printf(int fd, const char *fmt, ...)
{
 ...
 769:	e8 65 fe ff ff       	call   5d3 <write>
 ...
 7c9:	e8 05 fe ff ff       	call   5d3 <write>
        putc(fd, c);
      } else {
 ...
 7dd:	e8 f1 fd ff ff       	call   5d3 <write>
  for(i = 0; fmt[i]; i++){
 ...
 851:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 854:	e8 7a fd ff ff       	call   5d3 <write>
        ap++;
 ...
 8cb:	57                   	push   %edi
 8cc:	53                   	push   %ebx
 8cd:	e8 01 fd ff ff       	call   5d3 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9e8:	ff 75 e4             	push   -0x1c(%ebp)
 9eb:	e8 4b fc ff ff       	call   63b <sbrk>
  if(p == (char*)-1)
