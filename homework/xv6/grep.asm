 ...
 68c:	89 d1                	mov    %edx,%ecx
{
 ...
 6b9:	0f b6 92 00 0b 00 00 	movzbl 0xb00(%edx),%edx
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7a9:	ff 24 85 a8 0a 00 00 	jmp    *0xaa8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8b7:	90                   	nop
          s = "(null)";
 8b8:	ba 9e 0a 00 00       	mov    $0xa9e,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9e2:	e8 e9 fe ff ff       	call   8d0 <free>
  return freep;
 9e7:	a1 a0 12 00 00       	mov    0x12a0,%eax
 ...
 a14:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 a17:	a3 a0 12 00 00       	mov    %eax,0x12a0
}
