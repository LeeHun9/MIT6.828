...
free(void *ap)
{
 ...
 6a1:	a1 74 0b 00 00       	mov    0xb74,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 74 0b 00 00    	mov    %edx,0xb74
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 74 0b 00 00    	mov    %edx,0xb74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 798:	ff 75 e4             	push   -0x1c(%ebp)
 79b:	e8 7b fc ff ff       	call   41b <sbrk>
  if(p == (char*)-1)
