  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 18 03 00 00       	call   37b <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 1b 03 00 00       	call   3c3 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 e4 02 00 00       	call   3a3 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 db 02 00 00       	call   3ab <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 d0 02 00 00       	call   3c3 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 8c 02 00 00       	call   39b <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 8b 02 00 00       	call   3ab <close>

  wait();
 120:	e8 66 02 00 00       	call   38b <wait>

  exit();
 125:	e8 59 02 00 00       	call   383 <exit>
  path[8] += i;
...
strcmp(const char *p, const char *q)
{
 ...
 184:	eb 2e                	jmp    1b4 <strcmp+0x44>
 186:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 18d:	8d 76 00             	lea    0x0(%esi),%esi
 190:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    p++, q++;
 194:	83 c1 01             	add    $0x1,%ecx
 197:	8d 5a 01             	lea    0x1(%edx),%ebx
  while(*p && *p == *q)
 19a:	84 c0                	test   %al,%al
 19c:	74 12                	je     1b0 <strcmp+0x40>
    p++, q++;
 19e:	89 da                	mov    %ebx,%edx
  while(*p && *p == *q)
 1a0:	0f b6 1a             	movzbl (%edx),%ebx
 1a3:	38 c3                	cmp    %al,%bl
