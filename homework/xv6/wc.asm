...
main(int argc, char *argv[])
{
  ...
  59:	e8 8d 03 00 00       	call   3eb <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 58 03 00 00       	call   3c3 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
 ...
 16f:	e8 bc 03 00 00       	call   530 <printf>
    exit();
 174:	e8 4a 02 00 00       	call   3c3 <exit>
...
strcmp(const char *p, const char *q)
{
 ...
 1c4:	eb 2e                	jmp    1f4 <strcmp+0x44>
 1c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 1cd:	8d 76 00             	lea    0x0(%esi),%esi
 1d0:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    p++, q++;
 1d4:	83 c1 01             	add    $0x1,%ecx
 1d7:	8d 5a 01             	lea    0x1(%edx),%ebx
  while(*p && *p == *q)
 1da:	84 c0                	test   %al,%al
 1dc:	74 12                	je     1f0 <strcmp+0x40>
    p++, q++;
 1de:	89 da                	mov    %ebx,%edx
  while(*p && *p == *q)
 1e0:	0f b6 1a             	movzbl (%edx),%ebx
 1e3:	38 c3                	cmp    %al,%bl
 1e5:	74 e9                	je     1d0 <strcmp+0x20>
  return (uchar)*p - (uchar)*q;
 1e7:	29 d8                	sub    %ebx,%eax
}
 1e9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 1ec:	c9                   	leave  
 1ed:	c3                   	ret    
