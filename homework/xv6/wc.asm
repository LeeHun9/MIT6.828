 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 b8 08 00 00 	jmp    *0x8b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba af 08 00 00       	mov    $0x8af,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 00 0e 00 00       	mov    0xe00,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 00 0e 00 00       	mov    %eax,0xe00
}
