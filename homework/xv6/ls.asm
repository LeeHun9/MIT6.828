 ...
 65c:	89 d1                	mov    %edx,%ecx
{
 ...
 689:	0f b6 92 e4 0a 00 00 	movzbl 0xae4(%edx),%edx
 ...
 709:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 779:	ff 24 85 8c 0a 00 00 	jmp    *0xa8c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 887:	90                   	nop
          s = "(null)";
 888:	ba 82 0a 00 00       	mov    $0xa82,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 24 0e 00 00       	mov    0xe24,%eax
{
 ...
 8e1:	5b                   	pop    %ebx
  freep = p;
 8e2:	89 15 24 0e 00 00    	mov    %edx,0xe24
}
 8e8:	5e                   	pop    %esi
 8e9:	5f                   	pop    %edi
 8ea:	5d                   	pop    %ebp
 ...
 919:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 91c:	89 15 24 0e 00 00    	mov    %edx,0xe24
    p->s.size += bp->s.size;
 922:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
 925:	8b 43 f8             	mov    -0x8(%ebx),%eax
...
malloc(uint nbytes)
{
 ...
 939:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 93c:	8b 3d 24 0e 00 00    	mov    0xe24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 94d:	0f 84 ad 00 00 00    	je     a00 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 953:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
 955:	8b 48 04             	mov    0x4(%eax),%ecx
 958:	39 f1                	cmp    %esi,%ecx
 95a:	73 71                	jae    9cd <malloc+0x9d>
 95c:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
 962:	bb 00 10 00 00       	mov    $0x1000,%ebx
 967:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
 96a:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
 971:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
 974:	eb 1b                	jmp    991 <malloc+0x61>
 ...
 987:	73 4f                	jae    9d8 <malloc+0xa8>
    ...
    if(p == freep)
 989:	8b 3d 24 0e 00 00    	mov    0xe24,%edi
 98f:	89 d0                	mov    %edx,%eax
 991:	39 c7                	cmp    %eax,%edi
 993:	75 eb                	jne    980 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
 995:	83 ec 0c             	sub    $0xc,%esp
 998:	ff 75 e4             	push   -0x1c(%ebp)
 99b:	e8 7b fc ff ff       	call   61b <sbrk>
  if(p == (char*)-1)
 9a0:	83 c4 10             	add    $0x10,%esp
 9a3:	83 f8 ff             	cmp    $0xffffffff,%eax
 9a6:	74 1b                	je     9c3 <malloc+0x93>
  hp->s.size = nu;
 ...
 9b1:	50                   	push   %eax
 9b2:	e8 e9 fe ff ff       	call   8a0 <free>
  return freep;
 9b7:	a1 24 0e 00 00       	mov    0xe24,%eax
      if((p = morecore(nunits)) == 0)
 9bc:	83 c4 10             	add    $0x10,%esp
 9bf:	85 c0                	test   %eax,%eax
 9c1:	75 bd                	jne    980 <malloc+0x50>
        return 0;
  }
}
 ...
 9da:	74 54                	je     a30 <malloc+0x100>
        p->s.size -= nunits;
 9dc:	29 f1                	sub    %esi,%ecx
 9de:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
 9e1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
 9e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 9e7:	a3 24 0e 00 00       	mov    %eax,0xe24
}
 9ec:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
 9ef:	8d 42 08             	lea    0x8(%edx),%eax
}
 9f2:	5b                   	pop    %ebx
 9f3:	5e                   	pop    %esi
 9f4:	5f                   	pop    %edi
 9f5:	5d                   	pop    %ebp
 9f6:	c3                   	ret    
 9f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 ...
 a16:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a19:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 a1b:	c7 05 2c 0e 00 00 00 	movl   $0x0,0xe2c
 a22:	00 00 00 
    if(p->s.size >= nunits){
 a25:	e9 32 ff ff ff       	jmp    95c <malloc+0x2c>
 a2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
 a30:	8b 0a                	mov    (%edx),%ecx
 a32:	89 08                	mov    %ecx,(%eax)
 a34:	eb b1                	jmp    9e7 <malloc+0xb7>
