   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  34:	ff 75 ec             	push   -0x14(%ebp)
  37:	ff 75 f0             	push   -0x10(%ebp)
  3a:	ff 75 f4             	push   -0xc(%ebp)
  3d:	ff 75 e0             	push   -0x20(%ebp)
  40:	ff 75 e4             	push   -0x1c(%ebp)
  43:	ff 75 e8             	push   -0x18(%ebp)
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 80 07 00 00 	jmp    *0x780(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 78 07 00 00       	mov    $0x778,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 80 0a 00 00    	mov    %edx,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 80 0a 00 00       	mov    0xa80,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 742:	00 00 00 
    if(p->s.size >= nunits){
