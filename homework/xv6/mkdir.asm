 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 0c 08 00 00 	movzbl 0x80c(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 b4 07 00 00 	jmp    *0x7b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba ab 07 00 00       	mov    $0x7ab,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6c7:	73 4f                	jae    718 <malloc+0xa8>
    ...
    if(p == freep)
 6c9:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 6db:	e8 7b fc ff ff       	call   35b <sbrk>
  if(p == (char*)-1)
 ...
 6f2:	e8 e9 fe ff ff       	call   5e0 <free>
  return freep;
 6f7:	a1 c4 0a 00 00       	mov    0xac4,%eax
 ...
 724:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 727:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
