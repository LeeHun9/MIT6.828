 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 74 07 00 00 	jmp    *0x774(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 6c 07 00 00       	mov    $0x76c,%edx
        while(*s != 0){
 ...
 5c1:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 84 0a 00 00    	mov    %edx,0xa84
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 84 0a 00 00    	mov    %edx,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a7:	73 4f                	jae    6f8 <malloc+0xa8>
    ...
    if(p == freep)
 6a9:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 84 0a 00 00       	mov    0xa84,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 84 0a 00 00       	mov    %eax,0xa84
}
