 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 48 08 00 00 	jmp    *0x848(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 40 08 00 00       	mov    $0x840,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 757:	73 4f                	jae    7a8 <malloc+0xa8>
    ...
    if(p == freep)
 759:	8b 3d a0 0d 00 00    	mov    0xda0,%edi
 ...
 76b:	e8 7b fc ff ff       	call   3eb <sbrk>
  if(p == (char*)-1)
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 a0 0d 00 00       	mov    0xda0,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 a0 0d 00 00       	mov    %eax,0xda0
}
