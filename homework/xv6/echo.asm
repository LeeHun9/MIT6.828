 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 78 07 00 00 	jmp    *0x778(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 71 07 00 00       	mov    $0x771,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6b7:	73 4f                	jae    708 <malloc+0xa8>
    ...
    if(p == freep)
 6b9:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
 ...
 6cb:	e8 7b fc ff ff       	call   34b <sbrk>
  if(p == (char*)-1)
 ...
 6e2:	e8 e9 fe ff ff       	call   5d0 <free>
  return freep;
 6e7:	a1 84 0a 00 00       	mov    0xa84,%eax
 ...
 714:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 717:	a3 84 0a 00 00       	mov    %eax,0xa84
}
