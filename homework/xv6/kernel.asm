...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 97 7b 10 80 	movl   $0x80107b97,(%esp)
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 7f 58 10 80 	movl   $0x8010587f,0x14(%eax)
  p->context = (struct context*)sp;
...
801041fb:	68 97 7b 10 80       	push   $0x80107b97
...
80105833:	83 ec 1c             	sub    $0x1c,%esp
  struct rtcdate* r;

  if(argptr(0, (void*) &r, sizeof(*r)) < 0) {
80105836:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105839:	6a 18                	push   $0x18
8010583b:	50                   	push   %eax
8010583c:	6a 00                	push   $0x0
8010583e:	e8 2d f1 ff ff       	call   80104970 <argptr>
80105843:	83 c4 10             	add    $0x10,%esp
80105846:	85 c0                	test   %eax,%eax
80105848:	78 16                	js     80105860 <sys_date+0x30>
    return -1;
  }
...
80105850:	e8 7b d1 ff ff       	call   801029d0 <cmostime>
...
80105867:	1e                   	push   %ds
80105868:	06                   	push   %es
80105869:	0f a0                	push   %fs
8010586b:	0f a8                	push   %gs
8010586d:	60                   	pusha  
8010586e:	66 b8 10 00          	mov    $0x10,%ax
80105872:	8e d8                	mov    %eax,%ds
80105874:	8e c0                	mov    %eax,%es
80105876:	54                   	push   %esp
80105877:	e8 c4 00 00 00       	call   80105940 <trap>
8010587c:	83 c4 04             	add    $0x4,%esp

8010587f <trapret>:
8010587f:	61                   	popa   
80105880:	0f a9                	pop    %gs
80105882:	0f a1                	pop    %fs
80105884:	07                   	pop    %es
80105885:	1f                   	pop    %ds
80105886:	83 c4 08             	add    $0x8,%esp
80105889:	cf                   	iret   
...
801058de:	00 00 ef 
  initlock(&tickslock, "time");
801058e1:	68 9d 79 10 80       	push   $0x8010799d
...
801058f4:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
801058fa:	e8 d1 ea ff ff       	call   801043d0 <initlock>
}
...
80105952:	0f 84 68 01 00 00    	je     80105ac0 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010595e:	0f 87 8c 00 00 00    	ja     801059f0 <trap+0xb0>
80105964:	ff 24 85 60 7a 10 80 	jmp    *-0x7fef85a0(,%eax,4)
...
8010596f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105970:	e8 cb c8 ff ff       	call   80102240 <ideintr>
    lapiceoi();
80105975:	e8 96 cf ff ff       	call   80102910 <lapiceoi>
  }
...
8010597a:	e8 f1 df ff ff       	call   80103970 <myproc>
8010597f:	85 c0                	test   %eax,%eax
80105981:	74 1d                	je     801059a0 <trap+0x60>
80105983:	e8 e8 df ff ff       	call   80103970 <myproc>
80105988:	8b 50 24             	mov    0x24(%eax),%edx
8010598b:	85 d2                	test   %edx,%edx
8010598d:	74 11                	je     801059a0 <trap+0x60>
8010598f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105993:	83 e0 03             	and    $0x3,%eax
80105996:	66 83 f8 03          	cmp    $0x3,%ax
8010599a:	0f 84 e8 01 00 00    	je     80105b88 <trap+0x248>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801059a0:	e8 cb df ff ff       	call   80103970 <myproc>
801059a5:	85 c0                	test   %eax,%eax
801059a7:	74 0f                	je     801059b8 <trap+0x78>
801059a9:	e8 c2 df ff ff       	call   80103970 <myproc>
801059ae:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801059b2:	0f 84 b8 00 00 00    	je     80105a70 <trap+0x130>
...
801059bf:	74 1d                	je     801059de <trap+0x9e>
801059c1:	e8 aa df ff ff       	call   80103970 <myproc>
801059c6:	8b 40 24             	mov    0x24(%eax),%eax
801059c9:	85 c0                	test   %eax,%eax
801059cb:	74 11                	je     801059de <trap+0x9e>
801059cd:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059d1:	83 e0 03             	and    $0x3,%eax
801059d4:	66 83 f8 03          	cmp    $0x3,%ax
801059d8:	0f 84 0f 01 00 00    	je     80105aed <trap+0x1ad>
    exit();
}
801059de:	8d 65 f4             	lea    -0xc(%ebp),%esp
801059e1:	5b                   	pop    %ebx
801059e2:	5e                   	pop    %esi
801059e3:	5f                   	pop    %edi
801059e4:	5d                   	pop    %ebp
...
801059f0:	e8 7b df ff ff       	call   80103970 <myproc>
801059f5:	85 c0                	test   %eax,%eax
801059f7:	0f 84 f5 01 00 00    	je     80105bf2 <trap+0x2b2>
801059fd:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a01:	0f 84 eb 01 00 00    	je     80105bf2 <trap+0x2b2>
    if(tf->trapno == T_PGFLT) {    // Is Page fault?
80105a07:	83 7b 30 0e          	cmpl   $0xe,0x30(%ebx)
80105a0b:	0f 84 87 01 00 00    	je     80105b98 <trap+0x258>
...
80105a11:	0f 20 d1             	mov    %cr2,%ecx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a14:	8b 53 38             	mov    0x38(%ebx),%edx
80105a17:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105a1a:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105a1d:	e8 2e df ff ff       	call   80103950 <cpuid>
80105a22:	8b 73 30             	mov    0x30(%ebx),%esi
80105a25:	89 c7                	mov    %eax,%edi
...
80105a43:	ff 75 e4             	push   -0x1c(%ebp)
...
80105a4e:	ff 70 10             	push   0x10(%eax)
80105a51:	68 1c 7a 10 80       	push   $0x80107a1c
80105a56:	e8 45 ac ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
...
80105a6a:	e9 0b ff ff ff       	jmp    8010597a <trap+0x3a>
80105a6f:	90                   	nop
  if(myproc() && myproc()->state == RUNNING &&
80105a70:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105a74:	0f 85 3e ff ff ff    	jne    801059b8 <trap+0x78>
    yield();
80105a7a:	e8 71 e5 ff ff       	call   80103ff0 <yield>
80105a7f:	e9 34 ff ff ff       	jmp    801059b8 <trap+0x78>
...
80105a8f:	e8 bc de ff ff       	call   80103950 <cpuid>
80105a94:	57                   	push   %edi
80105a95:	56                   	push   %esi
80105a96:	50                   	push   %eax
80105a97:	68 c4 79 10 80       	push   $0x801079c4
80105a9c:	e8 ff ab ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105aa1:	e8 6a ce ff ff       	call   80102910 <lapiceoi>
    break;
80105aa6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aa9:	e8 c2 de ff ff       	call   80103970 <myproc>
80105aae:	85 c0                	test   %eax,%eax
80105ab0:	0f 85 cd fe ff ff    	jne    80105983 <trap+0x43>
80105ab6:	e9 e5 fe ff ff       	jmp    801059a0 <trap+0x60>
...
80105aca:	0f 85 18 01 00 00    	jne    80105be8 <trap+0x2a8>
    myproc()->tf = tf;
80105ad0:	e8 9b de ff ff       	call   80103970 <myproc>
80105ad5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ad8:	e8 83 ef ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105add:	e8 8e de ff ff       	call   80103970 <myproc>
80105ae2:	8b 48 24             	mov    0x24(%eax),%ecx
80105ae5:	85 c9                	test   %ecx,%ecx
80105ae7:	0f 84 f1 fe ff ff    	je     801059de <trap+0x9e>
}
...
80105af3:	5d                   	pop    %ebp
      exit();
80105af4:	e9 97 e2 ff ff       	jmp    80103d90 <exit>
80105af9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b00:	e8 8b 02 00 00       	call   80105d90 <uartintr>
    lapiceoi();
80105b05:	e8 06 ce ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b0a:	e8 61 de ff ff       	call   80103970 <myproc>
80105b0f:	85 c0                	test   %eax,%eax
80105b11:	0f 85 6c fe ff ff    	jne    80105983 <trap+0x43>
80105b17:	e9 84 fe ff ff       	jmp    801059a0 <trap+0x60>
...
80105b31:	0f 85 4c fe ff ff    	jne    80105983 <trap+0x43>
80105b37:	e9 64 fe ff ff       	jmp    801059a0 <trap+0x60>
80105b3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105b40:	e8 0b de ff ff       	call   80103950 <cpuid>
80105b45:	85 c0                	test   %eax,%eax
80105b47:	0f 85 28 fe ff ff    	jne    80105975 <trap+0x35>
      acquire(&tickslock);
80105b4d:	83 ec 0c             	sub    $0xc,%esp
80105b50:	68 80 3c 11 80       	push   $0x80113c80
80105b55:	e8 46 ea ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105b5a:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105b61:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105b68:	e8 93 e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
...
80105bb6:	83 c4 0c             	add    $0xc,%esp
80105bb9:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
80105bbf:	52                   	push   %edx
80105bc0:	56                   	push   %esi
80105bc1:	ff 70 04             	push   0x4(%eax)
80105bc4:	e8 17 11 00 00       	call   80106ce0 <allocuvm>
80105bc9:	83 c4 10             	add    $0x10,%esp
80105bcc:	85 c0                	test   %eax,%eax
80105bce:	0f 85 a6 fd ff ff    	jne    8010597a <trap+0x3a>
        panic("trap T_GPFLT");
80105bd4:	83 ec 0c             	sub    $0xc,%esp
80105bd7:	68 b6 79 10 80       	push   $0x801079b6
80105bdc:	e8 9f a7 ff ff       	call   80100380 <panic>
80105be1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      exit();
80105be8:	e8 a3 e1 ff ff       	call   80103d90 <exit>
80105bed:	e9 de fe ff ff       	jmp    80105ad0 <trap+0x190>
80105bf2:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105bf5:	8b 73 38             	mov    0x38(%ebx),%esi
80105bf8:	e8 53 dd ff ff       	call   80103950 <cpuid>
80105bfd:	83 ec 0c             	sub    $0xc,%esp
80105c00:	57                   	push   %edi
80105c01:	56                   	push   %esi
80105c02:	50                   	push   %eax
80105c03:	ff 73 30             	push   0x30(%ebx)
80105c06:	68 e8 79 10 80       	push   $0x801079e8
80105c0b:	e8 90 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c10:	83 c4 14             	add    $0x14,%esp
80105c13:	68 a2 79 10 80       	push   $0x801079a2
80105c18:	e8 63 a7 ff ff       	call   80100380 <panic>
...
80105cbc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cbf:	bf e0 7a 10 80       	mov    $0x80107ae0,%edi
...
80105da9:	e9 b9 fa ff ff       	jmp    80105867 <alltraps>

80105dae <vector1>:
80105dae:	6a 00                	push   $0x0
80105db0:	6a 01                	push   $0x1
80105db2:	e9 b0 fa ff ff       	jmp    80105867 <alltraps>

80105db7 <vector2>:
80105db7:	6a 00                	push   $0x0
80105db9:	6a 02                	push   $0x2
80105dbb:	e9 a7 fa ff ff       	jmp    80105867 <alltraps>

80105dc0 <vector3>:
80105dc0:	6a 00                	push   $0x0
80105dc2:	6a 03                	push   $0x3
80105dc4:	e9 9e fa ff ff       	jmp    80105867 <alltraps>

80105dc9 <vector4>:
80105dc9:	6a 00                	push   $0x0
80105dcb:	6a 04                	push   $0x4
80105dcd:	e9 95 fa ff ff       	jmp    80105867 <alltraps>

80105dd2 <vector5>:
80105dd2:	6a 00                	push   $0x0
80105dd4:	6a 05                	push   $0x5
80105dd6:	e9 8c fa ff ff       	jmp    80105867 <alltraps>

80105ddb <vector6>:
80105ddb:	6a 00                	push   $0x0
80105ddd:	6a 06                	push   $0x6
80105ddf:	e9 83 fa ff ff       	jmp    80105867 <alltraps>

80105de4 <vector7>:
80105de4:	6a 00                	push   $0x0
80105de6:	6a 07                	push   $0x7
80105de8:	e9 7a fa ff ff       	jmp    80105867 <alltraps>

80105ded <vector8>:
80105ded:	6a 08                	push   $0x8
80105def:	e9 73 fa ff ff       	jmp    80105867 <alltraps>

80105df4 <vector9>:
80105df4:	6a 00                	push   $0x0
80105df6:	6a 09                	push   $0x9
80105df8:	e9 6a fa ff ff       	jmp    80105867 <alltraps>

80105dfd <vector10>:
80105dfd:	6a 0a                	push   $0xa
80105dff:	e9 63 fa ff ff       	jmp    80105867 <alltraps>

80105e04 <vector11>:
80105e04:	6a 0b                	push   $0xb
80105e06:	e9 5c fa ff ff       	jmp    80105867 <alltraps>

80105e0b <vector12>:
80105e0b:	6a 0c                	push   $0xc
80105e0d:	e9 55 fa ff ff       	jmp    80105867 <alltraps>

80105e12 <vector13>:
80105e12:	6a 0d                	push   $0xd
80105e14:	e9 4e fa ff ff       	jmp    80105867 <alltraps>

80105e19 <vector14>:
80105e19:	6a 0e                	push   $0xe
80105e1b:	e9 47 fa ff ff       	jmp    80105867 <alltraps>

80105e20 <vector15>:
80105e20:	6a 00                	push   $0x0
80105e22:	6a 0f                	push   $0xf
80105e24:	e9 3e fa ff ff       	jmp    80105867 <alltraps>

80105e29 <vector16>:
80105e29:	6a 00                	push   $0x0
80105e2b:	6a 10                	push   $0x10
80105e2d:	e9 35 fa ff ff       	jmp    80105867 <alltraps>

80105e32 <vector17>:
80105e32:	6a 11                	push   $0x11
80105e34:	e9 2e fa ff ff       	jmp    80105867 <alltraps>

80105e39 <vector18>:
80105e39:	6a 00                	push   $0x0
80105e3b:	6a 12                	push   $0x12
80105e3d:	e9 25 fa ff ff       	jmp    80105867 <alltraps>

80105e42 <vector19>:
80105e42:	6a 00                	push   $0x0
80105e44:	6a 13                	push   $0x13
80105e46:	e9 1c fa ff ff       	jmp    80105867 <alltraps>

80105e4b <vector20>:
80105e4b:	6a 00                	push   $0x0
80105e4d:	6a 14                	push   $0x14
80105e4f:	e9 13 fa ff ff       	jmp    80105867 <alltraps>

80105e54 <vector21>:
80105e54:	6a 00                	push   $0x0
80105e56:	6a 15                	push   $0x15
80105e58:	e9 0a fa ff ff       	jmp    80105867 <alltraps>

80105e5d <vector22>:
80105e5d:	6a 00                	push   $0x0
80105e5f:	6a 16                	push   $0x16
80105e61:	e9 01 fa ff ff       	jmp    80105867 <alltraps>

80105e66 <vector23>:
80105e66:	6a 00                	push   $0x0
80105e68:	6a 17                	push   $0x17
80105e6a:	e9 f8 f9 ff ff       	jmp    80105867 <alltraps>

80105e6f <vector24>:
80105e6f:	6a 00                	push   $0x0
80105e71:	6a 18                	push   $0x18
80105e73:	e9 ef f9 ff ff       	jmp    80105867 <alltraps>

80105e78 <vector25>:
80105e78:	6a 00                	push   $0x0
80105e7a:	6a 19                	push   $0x19
80105e7c:	e9 e6 f9 ff ff       	jmp    80105867 <alltraps>

80105e81 <vector26>:
80105e81:	6a 00                	push   $0x0
80105e83:	6a 1a                	push   $0x1a
80105e85:	e9 dd f9 ff ff       	jmp    80105867 <alltraps>

80105e8a <vector27>:
80105e8a:	6a 00                	push   $0x0
80105e8c:	6a 1b                	push   $0x1b
80105e8e:	e9 d4 f9 ff ff       	jmp    80105867 <alltraps>

80105e93 <vector28>:
80105e93:	6a 00                	push   $0x0
80105e95:	6a 1c                	push   $0x1c
80105e97:	e9 cb f9 ff ff       	jmp    80105867 <alltraps>

80105e9c <vector29>:
80105e9c:	6a 00                	push   $0x0
80105e9e:	6a 1d                	push   $0x1d
80105ea0:	e9 c2 f9 ff ff       	jmp    80105867 <alltraps>

80105ea5 <vector30>:
80105ea5:	6a 00                	push   $0x0
80105ea7:	6a 1e                	push   $0x1e
80105ea9:	e9 b9 f9 ff ff       	jmp    80105867 <alltraps>

80105eae <vector31>:
80105eae:	6a 00                	push   $0x0
80105eb0:	6a 1f                	push   $0x1f
80105eb2:	e9 b0 f9 ff ff       	jmp    80105867 <alltraps>

80105eb7 <vector32>:
80105eb7:	6a 00                	push   $0x0
80105eb9:	6a 20                	push   $0x20
80105ebb:	e9 a7 f9 ff ff       	jmp    80105867 <alltraps>

80105ec0 <vector33>:
80105ec0:	6a 00                	push   $0x0
80105ec2:	6a 21                	push   $0x21
80105ec4:	e9 9e f9 ff ff       	jmp    80105867 <alltraps>

80105ec9 <vector34>:
80105ec9:	6a 00                	push   $0x0
80105ecb:	6a 22                	push   $0x22
80105ecd:	e9 95 f9 ff ff       	jmp    80105867 <alltraps>

80105ed2 <vector35>:
80105ed2:	6a 00                	push   $0x0
80105ed4:	6a 23                	push   $0x23
80105ed6:	e9 8c f9 ff ff       	jmp    80105867 <alltraps>

80105edb <vector36>:
80105edb:	6a 00                	push   $0x0
80105edd:	6a 24                	push   $0x24
80105edf:	e9 83 f9 ff ff       	jmp    80105867 <alltraps>

80105ee4 <vector37>:
80105ee4:	6a 00                	push   $0x0
80105ee6:	6a 25                	push   $0x25
80105ee8:	e9 7a f9 ff ff       	jmp    80105867 <alltraps>

80105eed <vector38>:
80105eed:	6a 00                	push   $0x0
80105eef:	6a 26                	push   $0x26
80105ef1:	e9 71 f9 ff ff       	jmp    80105867 <alltraps>

80105ef6 <vector39>:
80105ef6:	6a 00                	push   $0x0
80105ef8:	6a 27                	push   $0x27
80105efa:	e9 68 f9 ff ff       	jmp    80105867 <alltraps>

80105eff <vector40>:
80105eff:	6a 00                	push   $0x0
80105f01:	6a 28                	push   $0x28
80105f03:	e9 5f f9 ff ff       	jmp    80105867 <alltraps>

80105f08 <vector41>:
80105f08:	6a 00                	push   $0x0
80105f0a:	6a 29                	push   $0x29
80105f0c:	e9 56 f9 ff ff       	jmp    80105867 <alltraps>

80105f11 <vector42>:
80105f11:	6a 00                	push   $0x0
80105f13:	6a 2a                	push   $0x2a
80105f15:	e9 4d f9 ff ff       	jmp    80105867 <alltraps>

80105f1a <vector43>:
80105f1a:	6a 00                	push   $0x0
80105f1c:	6a 2b                	push   $0x2b
80105f1e:	e9 44 f9 ff ff       	jmp    80105867 <alltraps>

80105f23 <vector44>:
80105f23:	6a 00                	push   $0x0
80105f25:	6a 2c                	push   $0x2c
80105f27:	e9 3b f9 ff ff       	jmp    80105867 <alltraps>

80105f2c <vector45>:
80105f2c:	6a 00                	push   $0x0
80105f2e:	6a 2d                	push   $0x2d
80105f30:	e9 32 f9 ff ff       	jmp    80105867 <alltraps>

80105f35 <vector46>:
80105f35:	6a 00                	push   $0x0
80105f37:	6a 2e                	push   $0x2e
80105f39:	e9 29 f9 ff ff       	jmp    80105867 <alltraps>

80105f3e <vector47>:
80105f3e:	6a 00                	push   $0x0
80105f40:	6a 2f                	push   $0x2f
80105f42:	e9 20 f9 ff ff       	jmp    80105867 <alltraps>

80105f47 <vector48>:
80105f47:	6a 00                	push   $0x0
80105f49:	6a 30                	push   $0x30
80105f4b:	e9 17 f9 ff ff       	jmp    80105867 <alltraps>

80105f50 <vector49>:
80105f50:	6a 00                	push   $0x0
80105f52:	6a 31                	push   $0x31
80105f54:	e9 0e f9 ff ff       	jmp    80105867 <alltraps>

80105f59 <vector50>:
80105f59:	6a 00                	push   $0x0
80105f5b:	6a 32                	push   $0x32
80105f5d:	e9 05 f9 ff ff       	jmp    80105867 <alltraps>

80105f62 <vector51>:
80105f62:	6a 00                	push   $0x0
80105f64:	6a 33                	push   $0x33
80105f66:	e9 fc f8 ff ff       	jmp    80105867 <alltraps>

80105f6b <vector52>:
80105f6b:	6a 00                	push   $0x0
80105f6d:	6a 34                	push   $0x34
80105f6f:	e9 f3 f8 ff ff       	jmp    80105867 <alltraps>

80105f74 <vector53>:
80105f74:	6a 00                	push   $0x0
80105f76:	6a 35                	push   $0x35
80105f78:	e9 ea f8 ff ff       	jmp    80105867 <alltraps>

80105f7d <vector54>:
80105f7d:	6a 00                	push   $0x0
80105f7f:	6a 36                	push   $0x36
80105f81:	e9 e1 f8 ff ff       	jmp    80105867 <alltraps>

80105f86 <vector55>:
80105f86:	6a 00                	push   $0x0
80105f88:	6a 37                	push   $0x37
80105f8a:	e9 d8 f8 ff ff       	jmp    80105867 <alltraps>

80105f8f <vector56>:
80105f8f:	6a 00                	push   $0x0
80105f91:	6a 38                	push   $0x38
80105f93:	e9 cf f8 ff ff       	jmp    80105867 <alltraps>

80105f98 <vector57>:
80105f98:	6a 00                	push   $0x0
80105f9a:	6a 39                	push   $0x39
80105f9c:	e9 c6 f8 ff ff       	jmp    80105867 <alltraps>

80105fa1 <vector58>:
80105fa1:	6a 00                	push   $0x0
80105fa3:	6a 3a                	push   $0x3a
80105fa5:	e9 bd f8 ff ff       	jmp    80105867 <alltraps>

80105faa <vector59>:
80105faa:	6a 00                	push   $0x0
80105fac:	6a 3b                	push   $0x3b
80105fae:	e9 b4 f8 ff ff       	jmp    80105867 <alltraps>

80105fb3 <vector60>:
80105fb3:	6a 00                	push   $0x0
80105fb5:	6a 3c                	push   $0x3c
80105fb7:	e9 ab f8 ff ff       	jmp    80105867 <alltraps>

80105fbc <vector61>:
80105fbc:	6a 00                	push   $0x0
80105fbe:	6a 3d                	push   $0x3d
80105fc0:	e9 a2 f8 ff ff       	jmp    80105867 <alltraps>

80105fc5 <vector62>:
80105fc5:	6a 00                	push   $0x0
80105fc7:	6a 3e                	push   $0x3e
80105fc9:	e9 99 f8 ff ff       	jmp    80105867 <alltraps>

80105fce <vector63>:
80105fce:	6a 00                	push   $0x0
80105fd0:	6a 3f                	push   $0x3f
80105fd2:	e9 90 f8 ff ff       	jmp    80105867 <alltraps>

80105fd7 <vector64>:
80105fd7:	6a 00                	push   $0x0
80105fd9:	6a 40                	push   $0x40
80105fdb:	e9 87 f8 ff ff       	jmp    80105867 <alltraps>

80105fe0 <vector65>:
80105fe0:	6a 00                	push   $0x0
80105fe2:	6a 41                	push   $0x41
80105fe4:	e9 7e f8 ff ff       	jmp    80105867 <alltraps>

80105fe9 <vector66>:
80105fe9:	6a 00                	push   $0x0
80105feb:	6a 42                	push   $0x42
80105fed:	e9 75 f8 ff ff       	jmp    80105867 <alltraps>

80105ff2 <vector67>:
80105ff2:	6a 00                	push   $0x0
80105ff4:	6a 43                	push   $0x43
80105ff6:	e9 6c f8 ff ff       	jmp    80105867 <alltraps>

80105ffb <vector68>:
80105ffb:	6a 00                	push   $0x0
80105ffd:	6a 44                	push   $0x44
80105fff:	e9 63 f8 ff ff       	jmp    80105867 <alltraps>

80106004 <vector69>:
80106004:	6a 00                	push   $0x0
80106006:	6a 45                	push   $0x45
80106008:	e9 5a f8 ff ff       	jmp    80105867 <alltraps>

8010600d <vector70>:
8010600d:	6a 00                	push   $0x0
8010600f:	6a 46                	push   $0x46
80106011:	e9 51 f8 ff ff       	jmp    80105867 <alltraps>

80106016 <vector71>:
80106016:	6a 00                	push   $0x0
80106018:	6a 47                	push   $0x47
8010601a:	e9 48 f8 ff ff       	jmp    80105867 <alltraps>

8010601f <vector72>:
8010601f:	6a 00                	push   $0x0
80106021:	6a 48                	push   $0x48
80106023:	e9 3f f8 ff ff       	jmp    80105867 <alltraps>

80106028 <vector73>:
80106028:	6a 00                	push   $0x0
8010602a:	6a 49                	push   $0x49
8010602c:	e9 36 f8 ff ff       	jmp    80105867 <alltraps>

80106031 <vector74>:
80106031:	6a 00                	push   $0x0
80106033:	6a 4a                	push   $0x4a
80106035:	e9 2d f8 ff ff       	jmp    80105867 <alltraps>

8010603a <vector75>:
8010603a:	6a 00                	push   $0x0
8010603c:	6a 4b                	push   $0x4b
8010603e:	e9 24 f8 ff ff       	jmp    80105867 <alltraps>

80106043 <vector76>:
80106043:	6a 00                	push   $0x0
80106045:	6a 4c                	push   $0x4c
80106047:	e9 1b f8 ff ff       	jmp    80105867 <alltraps>

8010604c <vector77>:
8010604c:	6a 00                	push   $0x0
8010604e:	6a 4d                	push   $0x4d
80106050:	e9 12 f8 ff ff       	jmp    80105867 <alltraps>

80106055 <vector78>:
80106055:	6a 00                	push   $0x0
80106057:	6a 4e                	push   $0x4e
80106059:	e9 09 f8 ff ff       	jmp    80105867 <alltraps>

8010605e <vector79>:
8010605e:	6a 00                	push   $0x0
80106060:	6a 4f                	push   $0x4f
80106062:	e9 00 f8 ff ff       	jmp    80105867 <alltraps>

80106067 <vector80>:
80106067:	6a 00                	push   $0x0
80106069:	6a 50                	push   $0x50
8010606b:	e9 f7 f7 ff ff       	jmp    80105867 <alltraps>

80106070 <vector81>:
80106070:	6a 00                	push   $0x0
80106072:	6a 51                	push   $0x51
80106074:	e9 ee f7 ff ff       	jmp    80105867 <alltraps>

80106079 <vector82>:
80106079:	6a 00                	push   $0x0
8010607b:	6a 52                	push   $0x52
8010607d:	e9 e5 f7 ff ff       	jmp    80105867 <alltraps>

80106082 <vector83>:
80106082:	6a 00                	push   $0x0
80106084:	6a 53                	push   $0x53
80106086:	e9 dc f7 ff ff       	jmp    80105867 <alltraps>

8010608b <vector84>:
8010608b:	6a 00                	push   $0x0
8010608d:	6a 54                	push   $0x54
8010608f:	e9 d3 f7 ff ff       	jmp    80105867 <alltraps>

80106094 <vector85>:
80106094:	6a 00                	push   $0x0
80106096:	6a 55                	push   $0x55
80106098:	e9 ca f7 ff ff       	jmp    80105867 <alltraps>

8010609d <vector86>:
8010609d:	6a 00                	push   $0x0
8010609f:	6a 56                	push   $0x56
801060a1:	e9 c1 f7 ff ff       	jmp    80105867 <alltraps>

801060a6 <vector87>:
801060a6:	6a 00                	push   $0x0
801060a8:	6a 57                	push   $0x57
801060aa:	e9 b8 f7 ff ff       	jmp    80105867 <alltraps>

801060af <vector88>:
801060af:	6a 00                	push   $0x0
801060b1:	6a 58                	push   $0x58
801060b3:	e9 af f7 ff ff       	jmp    80105867 <alltraps>

801060b8 <vector89>:
801060b8:	6a 00                	push   $0x0
801060ba:	6a 59                	push   $0x59
801060bc:	e9 a6 f7 ff ff       	jmp    80105867 <alltraps>

801060c1 <vector90>:
801060c1:	6a 00                	push   $0x0
801060c3:	6a 5a                	push   $0x5a
801060c5:	e9 9d f7 ff ff       	jmp    80105867 <alltraps>

801060ca <vector91>:
801060ca:	6a 00                	push   $0x0
801060cc:	6a 5b                	push   $0x5b
801060ce:	e9 94 f7 ff ff       	jmp    80105867 <alltraps>

801060d3 <vector92>:
801060d3:	6a 00                	push   $0x0
801060d5:	6a 5c                	push   $0x5c
801060d7:	e9 8b f7 ff ff       	jmp    80105867 <alltraps>

801060dc <vector93>:
801060dc:	6a 00                	push   $0x0
801060de:	6a 5d                	push   $0x5d
801060e0:	e9 82 f7 ff ff       	jmp    80105867 <alltraps>

801060e5 <vector94>:
801060e5:	6a 00                	push   $0x0
801060e7:	6a 5e                	push   $0x5e
801060e9:	e9 79 f7 ff ff       	jmp    80105867 <alltraps>

801060ee <vector95>:
801060ee:	6a 00                	push   $0x0
801060f0:	6a 5f                	push   $0x5f
801060f2:	e9 70 f7 ff ff       	jmp    80105867 <alltraps>

801060f7 <vector96>:
801060f7:	6a 00                	push   $0x0
801060f9:	6a 60                	push   $0x60
801060fb:	e9 67 f7 ff ff       	jmp    80105867 <alltraps>

80106100 <vector97>:
80106100:	6a 00                	push   $0x0
80106102:	6a 61                	push   $0x61
80106104:	e9 5e f7 ff ff       	jmp    80105867 <alltraps>

80106109 <vector98>:
80106109:	6a 00                	push   $0x0
8010610b:	6a 62                	push   $0x62
8010610d:	e9 55 f7 ff ff       	jmp    80105867 <alltraps>

80106112 <vector99>:
80106112:	6a 00                	push   $0x0
80106114:	6a 63                	push   $0x63
80106116:	e9 4c f7 ff ff       	jmp    80105867 <alltraps>

8010611b <vector100>:
8010611b:	6a 00                	push   $0x0
8010611d:	6a 64                	push   $0x64
8010611f:	e9 43 f7 ff ff       	jmp    80105867 <alltraps>

80106124 <vector101>:
80106124:	6a 00                	push   $0x0
80106126:	6a 65                	push   $0x65
80106128:	e9 3a f7 ff ff       	jmp    80105867 <alltraps>

8010612d <vector102>:
8010612d:	6a 00                	push   $0x0
8010612f:	6a 66                	push   $0x66
80106131:	e9 31 f7 ff ff       	jmp    80105867 <alltraps>

80106136 <vector103>:
80106136:	6a 00                	push   $0x0
80106138:	6a 67                	push   $0x67
8010613a:	e9 28 f7 ff ff       	jmp    80105867 <alltraps>

8010613f <vector104>:
8010613f:	6a 00                	push   $0x0
80106141:	6a 68                	push   $0x68
80106143:	e9 1f f7 ff ff       	jmp    80105867 <alltraps>

80106148 <vector105>:
80106148:	6a 00                	push   $0x0
8010614a:	6a 69                	push   $0x69
8010614c:	e9 16 f7 ff ff       	jmp    80105867 <alltraps>

80106151 <vector106>:
80106151:	6a 00                	push   $0x0
80106153:	6a 6a                	push   $0x6a
80106155:	e9 0d f7 ff ff       	jmp    80105867 <alltraps>

8010615a <vector107>:
8010615a:	6a 00                	push   $0x0
8010615c:	6a 6b                	push   $0x6b
8010615e:	e9 04 f7 ff ff       	jmp    80105867 <alltraps>

80106163 <vector108>:
80106163:	6a 00                	push   $0x0
80106165:	6a 6c                	push   $0x6c
80106167:	e9 fb f6 ff ff       	jmp    80105867 <alltraps>

8010616c <vector109>:
8010616c:	6a 00                	push   $0x0
8010616e:	6a 6d                	push   $0x6d
80106170:	e9 f2 f6 ff ff       	jmp    80105867 <alltraps>

80106175 <vector110>:
80106175:	6a 00                	push   $0x0
80106177:	6a 6e                	push   $0x6e
80106179:	e9 e9 f6 ff ff       	jmp    80105867 <alltraps>

8010617e <vector111>:
8010617e:	6a 00                	push   $0x0
80106180:	6a 6f                	push   $0x6f
80106182:	e9 e0 f6 ff ff       	jmp    80105867 <alltraps>

80106187 <vector112>:
80106187:	6a 00                	push   $0x0
80106189:	6a 70                	push   $0x70
8010618b:	e9 d7 f6 ff ff       	jmp    80105867 <alltraps>

80106190 <vector113>:
80106190:	6a 00                	push   $0x0
80106192:	6a 71                	push   $0x71
80106194:	e9 ce f6 ff ff       	jmp    80105867 <alltraps>

80106199 <vector114>:
80106199:	6a 00                	push   $0x0
8010619b:	6a 72                	push   $0x72
8010619d:	e9 c5 f6 ff ff       	jmp    80105867 <alltraps>

801061a2 <vector115>:
801061a2:	6a 00                	push   $0x0
801061a4:	6a 73                	push   $0x73
801061a6:	e9 bc f6 ff ff       	jmp    80105867 <alltraps>

801061ab <vector116>:
801061ab:	6a 00                	push   $0x0
801061ad:	6a 74                	push   $0x74
801061af:	e9 b3 f6 ff ff       	jmp    80105867 <alltraps>

801061b4 <vector117>:
801061b4:	6a 00                	push   $0x0
801061b6:	6a 75                	push   $0x75
801061b8:	e9 aa f6 ff ff       	jmp    80105867 <alltraps>

801061bd <vector118>:
801061bd:	6a 00                	push   $0x0
801061bf:	6a 76                	push   $0x76
801061c1:	e9 a1 f6 ff ff       	jmp    80105867 <alltraps>

801061c6 <vector119>:
801061c6:	6a 00                	push   $0x0
801061c8:	6a 77                	push   $0x77
801061ca:	e9 98 f6 ff ff       	jmp    80105867 <alltraps>

801061cf <vector120>:
801061cf:	6a 00                	push   $0x0
801061d1:	6a 78                	push   $0x78
801061d3:	e9 8f f6 ff ff       	jmp    80105867 <alltraps>

801061d8 <vector121>:
801061d8:	6a 00                	push   $0x0
801061da:	6a 79                	push   $0x79
801061dc:	e9 86 f6 ff ff       	jmp    80105867 <alltraps>

801061e1 <vector122>:
801061e1:	6a 00                	push   $0x0
801061e3:	6a 7a                	push   $0x7a
801061e5:	e9 7d f6 ff ff       	jmp    80105867 <alltraps>

801061ea <vector123>:
801061ea:	6a 00                	push   $0x0
801061ec:	6a 7b                	push   $0x7b
801061ee:	e9 74 f6 ff ff       	jmp    80105867 <alltraps>

801061f3 <vector124>:
801061f3:	6a 00                	push   $0x0
801061f5:	6a 7c                	push   $0x7c
801061f7:	e9 6b f6 ff ff       	jmp    80105867 <alltraps>

801061fc <vector125>:
801061fc:	6a 00                	push   $0x0
801061fe:	6a 7d                	push   $0x7d
80106200:	e9 62 f6 ff ff       	jmp    80105867 <alltraps>

80106205 <vector126>:
80106205:	6a 00                	push   $0x0
80106207:	6a 7e                	push   $0x7e
80106209:	e9 59 f6 ff ff       	jmp    80105867 <alltraps>

8010620e <vector127>:
8010620e:	6a 00                	push   $0x0
80106210:	6a 7f                	push   $0x7f
80106212:	e9 50 f6 ff ff       	jmp    80105867 <alltraps>

80106217 <vector128>:
80106217:	6a 00                	push   $0x0
80106219:	68 80 00 00 00       	push   $0x80
8010621e:	e9 44 f6 ff ff       	jmp    80105867 <alltraps>

80106223 <vector129>:
80106223:	6a 00                	push   $0x0
80106225:	68 81 00 00 00       	push   $0x81
8010622a:	e9 38 f6 ff ff       	jmp    80105867 <alltraps>

8010622f <vector130>:
8010622f:	6a 00                	push   $0x0
80106231:	68 82 00 00 00       	push   $0x82
80106236:	e9 2c f6 ff ff       	jmp    80105867 <alltraps>

8010623b <vector131>:
8010623b:	6a 00                	push   $0x0
8010623d:	68 83 00 00 00       	push   $0x83
80106242:	e9 20 f6 ff ff       	jmp    80105867 <alltraps>

80106247 <vector132>:
80106247:	6a 00                	push   $0x0
80106249:	68 84 00 00 00       	push   $0x84
8010624e:	e9 14 f6 ff ff       	jmp    80105867 <alltraps>

80106253 <vector133>:
80106253:	6a 00                	push   $0x0
80106255:	68 85 00 00 00       	push   $0x85
8010625a:	e9 08 f6 ff ff       	jmp    80105867 <alltraps>

8010625f <vector134>:
8010625f:	6a 00                	push   $0x0
80106261:	68 86 00 00 00       	push   $0x86
80106266:	e9 fc f5 ff ff       	jmp    80105867 <alltraps>

8010626b <vector135>:
8010626b:	6a 00                	push   $0x0
8010626d:	68 87 00 00 00       	push   $0x87
80106272:	e9 f0 f5 ff ff       	jmp    80105867 <alltraps>

80106277 <vector136>:
80106277:	6a 00                	push   $0x0
80106279:	68 88 00 00 00       	push   $0x88
8010627e:	e9 e4 f5 ff ff       	jmp    80105867 <alltraps>

80106283 <vector137>:
80106283:	6a 00                	push   $0x0
80106285:	68 89 00 00 00       	push   $0x89
8010628a:	e9 d8 f5 ff ff       	jmp    80105867 <alltraps>

8010628f <vector138>:
8010628f:	6a 00                	push   $0x0
80106291:	68 8a 00 00 00       	push   $0x8a
80106296:	e9 cc f5 ff ff       	jmp    80105867 <alltraps>

8010629b <vector139>:
8010629b:	6a 00                	push   $0x0
8010629d:	68 8b 00 00 00       	push   $0x8b
801062a2:	e9 c0 f5 ff ff       	jmp    80105867 <alltraps>

801062a7 <vector140>:
801062a7:	6a 00                	push   $0x0
801062a9:	68 8c 00 00 00       	push   $0x8c
801062ae:	e9 b4 f5 ff ff       	jmp    80105867 <alltraps>

801062b3 <vector141>:
801062b3:	6a 00                	push   $0x0
801062b5:	68 8d 00 00 00       	push   $0x8d
801062ba:	e9 a8 f5 ff ff       	jmp    80105867 <alltraps>

801062bf <vector142>:
801062bf:	6a 00                	push   $0x0
801062c1:	68 8e 00 00 00       	push   $0x8e
801062c6:	e9 9c f5 ff ff       	jmp    80105867 <alltraps>

801062cb <vector143>:
801062cb:	6a 00                	push   $0x0
801062cd:	68 8f 00 00 00       	push   $0x8f
801062d2:	e9 90 f5 ff ff       	jmp    80105867 <alltraps>

801062d7 <vector144>:
801062d7:	6a 00                	push   $0x0
801062d9:	68 90 00 00 00       	push   $0x90
801062de:	e9 84 f5 ff ff       	jmp    80105867 <alltraps>

801062e3 <vector145>:
801062e3:	6a 00                	push   $0x0
801062e5:	68 91 00 00 00       	push   $0x91
801062ea:	e9 78 f5 ff ff       	jmp    80105867 <alltraps>

801062ef <vector146>:
801062ef:	6a 00                	push   $0x0
801062f1:	68 92 00 00 00       	push   $0x92
801062f6:	e9 6c f5 ff ff       	jmp    80105867 <alltraps>

801062fb <vector147>:
801062fb:	6a 00                	push   $0x0
801062fd:	68 93 00 00 00       	push   $0x93
80106302:	e9 60 f5 ff ff       	jmp    80105867 <alltraps>

80106307 <vector148>:
80106307:	6a 00                	push   $0x0
80106309:	68 94 00 00 00       	push   $0x94
8010630e:	e9 54 f5 ff ff       	jmp    80105867 <alltraps>

80106313 <vector149>:
80106313:	6a 00                	push   $0x0
80106315:	68 95 00 00 00       	push   $0x95
8010631a:	e9 48 f5 ff ff       	jmp    80105867 <alltraps>

8010631f <vector150>:
8010631f:	6a 00                	push   $0x0
80106321:	68 96 00 00 00       	push   $0x96
80106326:	e9 3c f5 ff ff       	jmp    80105867 <alltraps>

8010632b <vector151>:
8010632b:	6a 00                	push   $0x0
8010632d:	68 97 00 00 00       	push   $0x97
80106332:	e9 30 f5 ff ff       	jmp    80105867 <alltraps>

80106337 <vector152>:
80106337:	6a 00                	push   $0x0
80106339:	68 98 00 00 00       	push   $0x98
8010633e:	e9 24 f5 ff ff       	jmp    80105867 <alltraps>

80106343 <vector153>:
80106343:	6a 00                	push   $0x0
80106345:	68 99 00 00 00       	push   $0x99
8010634a:	e9 18 f5 ff ff       	jmp    80105867 <alltraps>

8010634f <vector154>:
8010634f:	6a 00                	push   $0x0
80106351:	68 9a 00 00 00       	push   $0x9a
80106356:	e9 0c f5 ff ff       	jmp    80105867 <alltraps>

8010635b <vector155>:
8010635b:	6a 00                	push   $0x0
8010635d:	68 9b 00 00 00       	push   $0x9b
80106362:	e9 00 f5 ff ff       	jmp    80105867 <alltraps>

80106367 <vector156>:
80106367:	6a 00                	push   $0x0
80106369:	68 9c 00 00 00       	push   $0x9c
8010636e:	e9 f4 f4 ff ff       	jmp    80105867 <alltraps>

80106373 <vector157>:
80106373:	6a 00                	push   $0x0
80106375:	68 9d 00 00 00       	push   $0x9d
8010637a:	e9 e8 f4 ff ff       	jmp    80105867 <alltraps>

8010637f <vector158>:
8010637f:	6a 00                	push   $0x0
80106381:	68 9e 00 00 00       	push   $0x9e
80106386:	e9 dc f4 ff ff       	jmp    80105867 <alltraps>

8010638b <vector159>:
8010638b:	6a 00                	push   $0x0
8010638d:	68 9f 00 00 00       	push   $0x9f
80106392:	e9 d0 f4 ff ff       	jmp    80105867 <alltraps>

80106397 <vector160>:
80106397:	6a 00                	push   $0x0
80106399:	68 a0 00 00 00       	push   $0xa0
8010639e:	e9 c4 f4 ff ff       	jmp    80105867 <alltraps>

801063a3 <vector161>:
801063a3:	6a 00                	push   $0x0
801063a5:	68 a1 00 00 00       	push   $0xa1
801063aa:	e9 b8 f4 ff ff       	jmp    80105867 <alltraps>

801063af <vector162>:
801063af:	6a 00                	push   $0x0
801063b1:	68 a2 00 00 00       	push   $0xa2
801063b6:	e9 ac f4 ff ff       	jmp    80105867 <alltraps>

801063bb <vector163>:
801063bb:	6a 00                	push   $0x0
801063bd:	68 a3 00 00 00       	push   $0xa3
801063c2:	e9 a0 f4 ff ff       	jmp    80105867 <alltraps>

801063c7 <vector164>:
801063c7:	6a 00                	push   $0x0
801063c9:	68 a4 00 00 00       	push   $0xa4
801063ce:	e9 94 f4 ff ff       	jmp    80105867 <alltraps>

801063d3 <vector165>:
801063d3:	6a 00                	push   $0x0
801063d5:	68 a5 00 00 00       	push   $0xa5
801063da:	e9 88 f4 ff ff       	jmp    80105867 <alltraps>

801063df <vector166>:
801063df:	6a 00                	push   $0x0
801063e1:	68 a6 00 00 00       	push   $0xa6
801063e6:	e9 7c f4 ff ff       	jmp    80105867 <alltraps>

801063eb <vector167>:
801063eb:	6a 00                	push   $0x0
801063ed:	68 a7 00 00 00       	push   $0xa7
801063f2:	e9 70 f4 ff ff       	jmp    80105867 <alltraps>

801063f7 <vector168>:
801063f7:	6a 00                	push   $0x0
801063f9:	68 a8 00 00 00       	push   $0xa8
801063fe:	e9 64 f4 ff ff       	jmp    80105867 <alltraps>

80106403 <vector169>:
80106403:	6a 00                	push   $0x0
80106405:	68 a9 00 00 00       	push   $0xa9
8010640a:	e9 58 f4 ff ff       	jmp    80105867 <alltraps>

8010640f <vector170>:
8010640f:	6a 00                	push   $0x0
80106411:	68 aa 00 00 00       	push   $0xaa
80106416:	e9 4c f4 ff ff       	jmp    80105867 <alltraps>

8010641b <vector171>:
8010641b:	6a 00                	push   $0x0
8010641d:	68 ab 00 00 00       	push   $0xab
80106422:	e9 40 f4 ff ff       	jmp    80105867 <alltraps>

80106427 <vector172>:
80106427:	6a 00                	push   $0x0
80106429:	68 ac 00 00 00       	push   $0xac
8010642e:	e9 34 f4 ff ff       	jmp    80105867 <alltraps>

80106433 <vector173>:
80106433:	6a 00                	push   $0x0
80106435:	68 ad 00 00 00       	push   $0xad
8010643a:	e9 28 f4 ff ff       	jmp    80105867 <alltraps>

8010643f <vector174>:
8010643f:	6a 00                	push   $0x0
80106441:	68 ae 00 00 00       	push   $0xae
80106446:	e9 1c f4 ff ff       	jmp    80105867 <alltraps>

8010644b <vector175>:
8010644b:	6a 00                	push   $0x0
8010644d:	68 af 00 00 00       	push   $0xaf
80106452:	e9 10 f4 ff ff       	jmp    80105867 <alltraps>

80106457 <vector176>:
80106457:	6a 00                	push   $0x0
80106459:	68 b0 00 00 00       	push   $0xb0
8010645e:	e9 04 f4 ff ff       	jmp    80105867 <alltraps>

80106463 <vector177>:
80106463:	6a 00                	push   $0x0
80106465:	68 b1 00 00 00       	push   $0xb1
8010646a:	e9 f8 f3 ff ff       	jmp    80105867 <alltraps>

8010646f <vector178>:
8010646f:	6a 00                	push   $0x0
80106471:	68 b2 00 00 00       	push   $0xb2
80106476:	e9 ec f3 ff ff       	jmp    80105867 <alltraps>

8010647b <vector179>:
8010647b:	6a 00                	push   $0x0
8010647d:	68 b3 00 00 00       	push   $0xb3
80106482:	e9 e0 f3 ff ff       	jmp    80105867 <alltraps>

80106487 <vector180>:
80106487:	6a 00                	push   $0x0
80106489:	68 b4 00 00 00       	push   $0xb4
8010648e:	e9 d4 f3 ff ff       	jmp    80105867 <alltraps>

80106493 <vector181>:
80106493:	6a 00                	push   $0x0
80106495:	68 b5 00 00 00       	push   $0xb5
8010649a:	e9 c8 f3 ff ff       	jmp    80105867 <alltraps>

8010649f <vector182>:
8010649f:	6a 00                	push   $0x0
801064a1:	68 b6 00 00 00       	push   $0xb6
801064a6:	e9 bc f3 ff ff       	jmp    80105867 <alltraps>

801064ab <vector183>:
801064ab:	6a 00                	push   $0x0
801064ad:	68 b7 00 00 00       	push   $0xb7
801064b2:	e9 b0 f3 ff ff       	jmp    80105867 <alltraps>

801064b7 <vector184>:
801064b7:	6a 00                	push   $0x0
801064b9:	68 b8 00 00 00       	push   $0xb8
801064be:	e9 a4 f3 ff ff       	jmp    80105867 <alltraps>

801064c3 <vector185>:
801064c3:	6a 00                	push   $0x0
801064c5:	68 b9 00 00 00       	push   $0xb9
801064ca:	e9 98 f3 ff ff       	jmp    80105867 <alltraps>

801064cf <vector186>:
801064cf:	6a 00                	push   $0x0
801064d1:	68 ba 00 00 00       	push   $0xba
801064d6:	e9 8c f3 ff ff       	jmp    80105867 <alltraps>

801064db <vector187>:
801064db:	6a 00                	push   $0x0
801064dd:	68 bb 00 00 00       	push   $0xbb
801064e2:	e9 80 f3 ff ff       	jmp    80105867 <alltraps>

801064e7 <vector188>:
801064e7:	6a 00                	push   $0x0
801064e9:	68 bc 00 00 00       	push   $0xbc
801064ee:	e9 74 f3 ff ff       	jmp    80105867 <alltraps>

801064f3 <vector189>:
801064f3:	6a 00                	push   $0x0
801064f5:	68 bd 00 00 00       	push   $0xbd
801064fa:	e9 68 f3 ff ff       	jmp    80105867 <alltraps>

801064ff <vector190>:
801064ff:	6a 00                	push   $0x0
80106501:	68 be 00 00 00       	push   $0xbe
80106506:	e9 5c f3 ff ff       	jmp    80105867 <alltraps>

8010650b <vector191>:
8010650b:	6a 00                	push   $0x0
8010650d:	68 bf 00 00 00       	push   $0xbf
80106512:	e9 50 f3 ff ff       	jmp    80105867 <alltraps>

80106517 <vector192>:
80106517:	6a 00                	push   $0x0
80106519:	68 c0 00 00 00       	push   $0xc0
8010651e:	e9 44 f3 ff ff       	jmp    80105867 <alltraps>

80106523 <vector193>:
80106523:	6a 00                	push   $0x0
80106525:	68 c1 00 00 00       	push   $0xc1
8010652a:	e9 38 f3 ff ff       	jmp    80105867 <alltraps>

8010652f <vector194>:
8010652f:	6a 00                	push   $0x0
80106531:	68 c2 00 00 00       	push   $0xc2
80106536:	e9 2c f3 ff ff       	jmp    80105867 <alltraps>

8010653b <vector195>:
8010653b:	6a 00                	push   $0x0
8010653d:	68 c3 00 00 00       	push   $0xc3
80106542:	e9 20 f3 ff ff       	jmp    80105867 <alltraps>

80106547 <vector196>:
80106547:	6a 00                	push   $0x0
80106549:	68 c4 00 00 00       	push   $0xc4
8010654e:	e9 14 f3 ff ff       	jmp    80105867 <alltraps>

80106553 <vector197>:
80106553:	6a 00                	push   $0x0
80106555:	68 c5 00 00 00       	push   $0xc5
8010655a:	e9 08 f3 ff ff       	jmp    80105867 <alltraps>

8010655f <vector198>:
8010655f:	6a 00                	push   $0x0
80106561:	68 c6 00 00 00       	push   $0xc6
80106566:	e9 fc f2 ff ff       	jmp    80105867 <alltraps>

8010656b <vector199>:
8010656b:	6a 00                	push   $0x0
8010656d:	68 c7 00 00 00       	push   $0xc7
80106572:	e9 f0 f2 ff ff       	jmp    80105867 <alltraps>

80106577 <vector200>:
80106577:	6a 00                	push   $0x0
80106579:	68 c8 00 00 00       	push   $0xc8
8010657e:	e9 e4 f2 ff ff       	jmp    80105867 <alltraps>

80106583 <vector201>:
80106583:	6a 00                	push   $0x0
80106585:	68 c9 00 00 00       	push   $0xc9
8010658a:	e9 d8 f2 ff ff       	jmp    80105867 <alltraps>

8010658f <vector202>:
8010658f:	6a 00                	push   $0x0
80106591:	68 ca 00 00 00       	push   $0xca
80106596:	e9 cc f2 ff ff       	jmp    80105867 <alltraps>

8010659b <vector203>:
8010659b:	6a 00                	push   $0x0
8010659d:	68 cb 00 00 00       	push   $0xcb
801065a2:	e9 c0 f2 ff ff       	jmp    80105867 <alltraps>

801065a7 <vector204>:
801065a7:	6a 00                	push   $0x0
801065a9:	68 cc 00 00 00       	push   $0xcc
801065ae:	e9 b4 f2 ff ff       	jmp    80105867 <alltraps>

801065b3 <vector205>:
801065b3:	6a 00                	push   $0x0
801065b5:	68 cd 00 00 00       	push   $0xcd
801065ba:	e9 a8 f2 ff ff       	jmp    80105867 <alltraps>

801065bf <vector206>:
801065bf:	6a 00                	push   $0x0
801065c1:	68 ce 00 00 00       	push   $0xce
801065c6:	e9 9c f2 ff ff       	jmp    80105867 <alltraps>

801065cb <vector207>:
801065cb:	6a 00                	push   $0x0
801065cd:	68 cf 00 00 00       	push   $0xcf
801065d2:	e9 90 f2 ff ff       	jmp    80105867 <alltraps>

801065d7 <vector208>:
801065d7:	6a 00                	push   $0x0
801065d9:	68 d0 00 00 00       	push   $0xd0
801065de:	e9 84 f2 ff ff       	jmp    80105867 <alltraps>

801065e3 <vector209>:
801065e3:	6a 00                	push   $0x0
801065e5:	68 d1 00 00 00       	push   $0xd1
801065ea:	e9 78 f2 ff ff       	jmp    80105867 <alltraps>

801065ef <vector210>:
801065ef:	6a 00                	push   $0x0
801065f1:	68 d2 00 00 00       	push   $0xd2
801065f6:	e9 6c f2 ff ff       	jmp    80105867 <alltraps>

801065fb <vector211>:
801065fb:	6a 00                	push   $0x0
801065fd:	68 d3 00 00 00       	push   $0xd3
80106602:	e9 60 f2 ff ff       	jmp    80105867 <alltraps>

80106607 <vector212>:
80106607:	6a 00                	push   $0x0
80106609:	68 d4 00 00 00       	push   $0xd4
8010660e:	e9 54 f2 ff ff       	jmp    80105867 <alltraps>

80106613 <vector213>:
80106613:	6a 00                	push   $0x0
80106615:	68 d5 00 00 00       	push   $0xd5
8010661a:	e9 48 f2 ff ff       	jmp    80105867 <alltraps>

8010661f <vector214>:
8010661f:	6a 00                	push   $0x0
80106621:	68 d6 00 00 00       	push   $0xd6
80106626:	e9 3c f2 ff ff       	jmp    80105867 <alltraps>

8010662b <vector215>:
8010662b:	6a 00                	push   $0x0
8010662d:	68 d7 00 00 00       	push   $0xd7
80106632:	e9 30 f2 ff ff       	jmp    80105867 <alltraps>

80106637 <vector216>:
80106637:	6a 00                	push   $0x0
80106639:	68 d8 00 00 00       	push   $0xd8
8010663e:	e9 24 f2 ff ff       	jmp    80105867 <alltraps>

80106643 <vector217>:
80106643:	6a 00                	push   $0x0
80106645:	68 d9 00 00 00       	push   $0xd9
8010664a:	e9 18 f2 ff ff       	jmp    80105867 <alltraps>

8010664f <vector218>:
8010664f:	6a 00                	push   $0x0
80106651:	68 da 00 00 00       	push   $0xda
80106656:	e9 0c f2 ff ff       	jmp    80105867 <alltraps>

8010665b <vector219>:
8010665b:	6a 00                	push   $0x0
8010665d:	68 db 00 00 00       	push   $0xdb
80106662:	e9 00 f2 ff ff       	jmp    80105867 <alltraps>

80106667 <vector220>:
80106667:	6a 00                	push   $0x0
80106669:	68 dc 00 00 00       	push   $0xdc
8010666e:	e9 f4 f1 ff ff       	jmp    80105867 <alltraps>

80106673 <vector221>:
80106673:	6a 00                	push   $0x0
80106675:	68 dd 00 00 00       	push   $0xdd
8010667a:	e9 e8 f1 ff ff       	jmp    80105867 <alltraps>

8010667f <vector222>:
8010667f:	6a 00                	push   $0x0
80106681:	68 de 00 00 00       	push   $0xde
80106686:	e9 dc f1 ff ff       	jmp    80105867 <alltraps>

8010668b <vector223>:
8010668b:	6a 00                	push   $0x0
8010668d:	68 df 00 00 00       	push   $0xdf
80106692:	e9 d0 f1 ff ff       	jmp    80105867 <alltraps>

80106697 <vector224>:
80106697:	6a 00                	push   $0x0
80106699:	68 e0 00 00 00       	push   $0xe0
8010669e:	e9 c4 f1 ff ff       	jmp    80105867 <alltraps>

801066a3 <vector225>:
801066a3:	6a 00                	push   $0x0
801066a5:	68 e1 00 00 00       	push   $0xe1
801066aa:	e9 b8 f1 ff ff       	jmp    80105867 <alltraps>

801066af <vector226>:
801066af:	6a 00                	push   $0x0
801066b1:	68 e2 00 00 00       	push   $0xe2
801066b6:	e9 ac f1 ff ff       	jmp    80105867 <alltraps>

801066bb <vector227>:
801066bb:	6a 00                	push   $0x0
801066bd:	68 e3 00 00 00       	push   $0xe3
801066c2:	e9 a0 f1 ff ff       	jmp    80105867 <alltraps>

801066c7 <vector228>:
801066c7:	6a 00                	push   $0x0
801066c9:	68 e4 00 00 00       	push   $0xe4
801066ce:	e9 94 f1 ff ff       	jmp    80105867 <alltraps>

801066d3 <vector229>:
801066d3:	6a 00                	push   $0x0
801066d5:	68 e5 00 00 00       	push   $0xe5
801066da:	e9 88 f1 ff ff       	jmp    80105867 <alltraps>

801066df <vector230>:
801066df:	6a 00                	push   $0x0
801066e1:	68 e6 00 00 00       	push   $0xe6
801066e6:	e9 7c f1 ff ff       	jmp    80105867 <alltraps>

801066eb <vector231>:
801066eb:	6a 00                	push   $0x0
801066ed:	68 e7 00 00 00       	push   $0xe7
801066f2:	e9 70 f1 ff ff       	jmp    80105867 <alltraps>

801066f7 <vector232>:
801066f7:	6a 00                	push   $0x0
801066f9:	68 e8 00 00 00       	push   $0xe8
801066fe:	e9 64 f1 ff ff       	jmp    80105867 <alltraps>

80106703 <vector233>:
80106703:	6a 00                	push   $0x0
80106705:	68 e9 00 00 00       	push   $0xe9
8010670a:	e9 58 f1 ff ff       	jmp    80105867 <alltraps>

8010670f <vector234>:
8010670f:	6a 00                	push   $0x0
80106711:	68 ea 00 00 00       	push   $0xea
80106716:	e9 4c f1 ff ff       	jmp    80105867 <alltraps>

8010671b <vector235>:
8010671b:	6a 00                	push   $0x0
8010671d:	68 eb 00 00 00       	push   $0xeb
80106722:	e9 40 f1 ff ff       	jmp    80105867 <alltraps>

80106727 <vector236>:
80106727:	6a 00                	push   $0x0
80106729:	68 ec 00 00 00       	push   $0xec
8010672e:	e9 34 f1 ff ff       	jmp    80105867 <alltraps>

80106733 <vector237>:
80106733:	6a 00                	push   $0x0
80106735:	68 ed 00 00 00       	push   $0xed
8010673a:	e9 28 f1 ff ff       	jmp    80105867 <alltraps>

8010673f <vector238>:
8010673f:	6a 00                	push   $0x0
80106741:	68 ee 00 00 00       	push   $0xee
80106746:	e9 1c f1 ff ff       	jmp    80105867 <alltraps>

8010674b <vector239>:
8010674b:	6a 00                	push   $0x0
8010674d:	68 ef 00 00 00       	push   $0xef
80106752:	e9 10 f1 ff ff       	jmp    80105867 <alltraps>

80106757 <vector240>:
80106757:	6a 00                	push   $0x0
80106759:	68 f0 00 00 00       	push   $0xf0
8010675e:	e9 04 f1 ff ff       	jmp    80105867 <alltraps>

80106763 <vector241>:
80106763:	6a 00                	push   $0x0
80106765:	68 f1 00 00 00       	push   $0xf1
8010676a:	e9 f8 f0 ff ff       	jmp    80105867 <alltraps>

8010676f <vector242>:
8010676f:	6a 00                	push   $0x0
80106771:	68 f2 00 00 00       	push   $0xf2
80106776:	e9 ec f0 ff ff       	jmp    80105867 <alltraps>

8010677b <vector243>:
8010677b:	6a 00                	push   $0x0
8010677d:	68 f3 00 00 00       	push   $0xf3
80106782:	e9 e0 f0 ff ff       	jmp    80105867 <alltraps>

80106787 <vector244>:
80106787:	6a 00                	push   $0x0
80106789:	68 f4 00 00 00       	push   $0xf4
8010678e:	e9 d4 f0 ff ff       	jmp    80105867 <alltraps>

80106793 <vector245>:
80106793:	6a 00                	push   $0x0
80106795:	68 f5 00 00 00       	push   $0xf5
8010679a:	e9 c8 f0 ff ff       	jmp    80105867 <alltraps>

8010679f <vector246>:
8010679f:	6a 00                	push   $0x0
801067a1:	68 f6 00 00 00       	push   $0xf6
801067a6:	e9 bc f0 ff ff       	jmp    80105867 <alltraps>

801067ab <vector247>:
801067ab:	6a 00                	push   $0x0
801067ad:	68 f7 00 00 00       	push   $0xf7
801067b2:	e9 b0 f0 ff ff       	jmp    80105867 <alltraps>

801067b7 <vector248>:
801067b7:	6a 00                	push   $0x0
801067b9:	68 f8 00 00 00       	push   $0xf8
801067be:	e9 a4 f0 ff ff       	jmp    80105867 <alltraps>

801067c3 <vector249>:
801067c3:	6a 00                	push   $0x0
801067c5:	68 f9 00 00 00       	push   $0xf9
801067ca:	e9 98 f0 ff ff       	jmp    80105867 <alltraps>

801067cf <vector250>:
801067cf:	6a 00                	push   $0x0
801067d1:	68 fa 00 00 00       	push   $0xfa
801067d6:	e9 8c f0 ff ff       	jmp    80105867 <alltraps>

801067db <vector251>:
801067db:	6a 00                	push   $0x0
801067dd:	68 fb 00 00 00       	push   $0xfb
801067e2:	e9 80 f0 ff ff       	jmp    80105867 <alltraps>

801067e7 <vector252>:
801067e7:	6a 00                	push   $0x0
801067e9:	68 fc 00 00 00       	push   $0xfc
801067ee:	e9 74 f0 ff ff       	jmp    80105867 <alltraps>

801067f3 <vector253>:
801067f3:	6a 00                	push   $0x0
801067f5:	68 fd 00 00 00       	push   $0xfd
801067fa:	e9 68 f0 ff ff       	jmp    80105867 <alltraps>

801067ff <vector254>:
801067ff:	6a 00                	push   $0x0
80106801:	68 fe 00 00 00       	push   $0xfe
80106806:	e9 5c f0 ff ff       	jmp    80105867 <alltraps>

8010680b <vector255>:
8010680b:	6a 00                	push   $0x0
8010680d:	68 ff 00 00 00       	push   $0xff
80106812:	e9 50 f0 ff ff       	jmp    80105867 <alltraps>
...
80106965:	e8 f6 dc ff ff       	call   80104660 <memset>
...
801069ad:	68 e8 7a 10 80       	push   $0x80107ae8
...
801069c6:	e8 85 cf ff ff       	call   80103950 <cpuid>
...
80106bd1:	5f                   	pop    %edi
80106bd2:	5d                   	pop    %ebp
80106bd3:	e9 28 db ff ff       	jmp    80104700 <memmove>
80106bd8:	83 ec 0c             	sub    $0xc,%esp
80106bdb:	68 2d 7b 10 80       	push   $0x80107b2d
...
80106c40:	68 47 7b 10 80       	push   $0x80107b47
...
80106cc8:	68 e8 7b 10 80       	push   $0x80107be8
...
80106d69:	68 65 7b 10 80       	push   $0x80107b65
...
80106dcb:	68 7d 7b 10 80       	push   $0x80107b7d
...
80106eac:	68 99 7b 10 80       	push   $0x80107b99
...
80106f7c:	68 aa 7b 10 80       	push   $0x80107baa
...
80106ff2:	68 b4 7b 10 80       	push   $0x80107bb4
...
80107050:	e8 ab d6 ff ff       	call   80104700 <memmove>
80107055:	58                   	pop    %eax
...
801070c7:	68 ce 7b 10 80       	push   $0x80107bce
