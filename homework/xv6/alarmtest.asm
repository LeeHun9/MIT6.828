   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  27:	6a 0a                	push   $0xa
  29:	e8 6d 03 00 00       	call   39b <alarm>
  ...
  56:	83 c3 01             	add    $0x1,%ebx
      write(2, ".", 1);
  59:	6a 01                	push   $0x1
  5b:	68 b4 07 00 00       	push   $0x7b4
  60:	6a 02                	push   $0x2
  62:	e8 ac 02 00 00       	call   313 <write>
...
free(void *ap)
{
 ...
 601:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 e4 0a 00 00    	mov    %edx,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e7:	73 4f                	jae    738 <malloc+0xa8>
    ...
    if(p == freep)
 6e9:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 6fb:	e8 7b fc ff ff       	call   37b <sbrk>
  if(p == (char*)-1)
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 e4 0a 00 00       	mov    0xae4,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
