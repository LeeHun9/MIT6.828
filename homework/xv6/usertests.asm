    ...
    399c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    39c9:	0f b6 92 70 55 00 00 	movzbl 0x5570(%edx),%edx
    ...
    3a49:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ab9:	ff 24 85 18 55 00 00 	jmp    *0x5518(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3bc7:	90                   	nop
          s = "(null)";
    3bc8:	ba 0e 55 00 00       	mov    $0x550e,%edx
        while(*s != 0){
    ...
    3be1:	a1 20 a6 00 00       	mov    0xa620,%eax
{
  ...
  freep = p;
    ...
    p->s.ptr = bp->s.ptr;
    3c65:	8b 43 f8             	mov    -0x8(%ebx),%eax
    3c68:	89 02                	mov    %eax,(%edx)
}
    3c6a:	5b                   	pop    %ebx
    3c6b:	5e                   	pop    %esi
    3c6c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    3c8d:	0f 84 ad 00 00 00    	je     3d40 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3c93:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
    3c95:	8b 48 04             	mov    0x4(%eax),%ecx
    3c98:	39 f1                	cmp    %esi,%ecx
    3c9a:	73 71                	jae    3d0d <malloc+0x9d>
    3c9c:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    3ca2:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3ca7:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3caa:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
    3cb1:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    3cb4:	eb 1b                	jmp    3cd1 <malloc+0x61>
    3cb6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3cbd:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3cc0:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
    3cc2:	8b 4a 04             	mov    0x4(%edx),%ecx
    3cc5:	39 f1                	cmp    %esi,%ecx
    3cc7:	73 4f                	jae    3d18 <malloc+0xa8>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3cc9:	8b 3d 20 a6 00 00    	mov    0xa620,%edi
    3ccf:	89 d0                	mov    %edx,%eax
    3cd1:	39 c7                	cmp    %eax,%edi
    3cd3:	75 eb                	jne    3cc0 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
    3cd5:	83 ec 0c             	sub    $0xc,%esp
    3cd8:	ff 75 e4             	push   -0x1c(%ebp)
    3cdb:	e8 7b fc ff ff       	call   395b <sbrk>
  if(p == (char*)-1)
    3ce0:	83 c4 10             	add    $0x10,%esp
    3ce3:	83 f8 ff             	cmp    $0xffffffff,%eax
    3ce6:	74 1b                	je     3d03 <malloc+0x93>
  hp->s.size = nu;
    3ce8:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3ceb:	83 ec 0c             	sub    $0xc,%esp
    3cee:	83 c0 08             	add    $0x8,%eax
    3cf1:	50                   	push   %eax
    3cf2:	e8 e9 fe ff ff       	call   3be0 <free>
  return freep;
    3cf7:	a1 20 a6 00 00       	mov    0xa620,%eax
      if((p = morecore(nunits)) == 0)
    3cfc:	83 c4 10             	add    $0x10,%esp
    3cff:	85 c0                	test   %eax,%eax
    3d01:	75 bd                	jne    3cc0 <malloc+0x50>
        return 0;
  }
}
    3d03:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    3d06:	31 c0                	xor    %eax,%eax
}
    3d08:	5b                   	pop    %ebx
    3d09:	5e                   	pop    %esi
    3d0a:	5f                   	pop    %edi
    ...
    3d0c:	c3                   	ret    
    if(p->s.size >= nunits){
    3d0d:	89 c2                	mov    %eax,%edx
    3d0f:	89 f8                	mov    %edi,%eax
    3d11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    3d18:	39 ce                	cmp    %ecx,%esi
    3d1a:	74 54                	je     3d70 <malloc+0x100>
        p->s.size -= nunits;
    3d1c:	29 f1                	sub    %esi,%ecx
    3d1e:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
    3d21:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
    3d24:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3d27:	a3 20 a6 00 00       	mov    %eax,0xa620
}
    3d2c:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3d2f:	8d 42 08             	lea    0x8(%edx),%eax
}
    3d32:	5b                   	pop    %ebx
    3d33:	5e                   	pop    %esi
    3d34:	5f                   	pop    %edi
    3d35:	5d                   	pop    %ebp
    3d36:	c3                   	ret    
    3d37:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d62:	00 00 00 
    if(p->s.size >= nunits){
    3d65:	e9 32 ff ff ff       	jmp    3c9c <malloc+0x2c>
    3d6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3d70:	8b 0a                	mov    (%edx),%ecx
    3d72:	89 08                	mov    %ecx,(%eax)
    3d74:	eb b1                	jmp    3d27 <malloc+0xb7>
